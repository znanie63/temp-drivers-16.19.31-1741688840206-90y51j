...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF26E3BA);
  late Color secondary = const Color(0xFFE9FFFA);
  late Color tertiary = const Color(0xFF21CCA7);
  late Color alternate = const Color(0xFFE3E3E3);
  late Color primaryText = const Color(0xFF201E1E);
  late Color secondaryText = const Color(0xFF828282);
  late Color primaryBackground = const Color(0xFFFDFDFD);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFF6F6F6);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF678B);
